...
// Vault Select — exports BOTH the legacy native flat API
//   `<Select options={[{value,label}]} {...props} />`
// and the canonical shadcn Radix-based family for new code:
//   `<SelectRoot><SelectTrigger><SelectValue /></SelectTrigger>
...
>(({ className, children, position = 'popper', ...props }, ref) => (
  <SelectPrimitive.Portal>
    <SelectPrimitive.Content
      ref={ref}
      className={cn(
        'relative z-[300] max-h-96 min-w-[8rem] overflow-hidden rounded-[--radius-lg]',
        'border border-border bg-popover text-popover-foreground shadow-[var(--shadow-md)]',
...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Item
    ref={ref}
    className={cn(
      'relative flex w-full cursor-pointer select-none items-center rounded-[--radius-md]',
      'py-1.5 pl-8 pr-2 text-[13px] outline-none',
      'transition-colors duration-150 ease-[var(--ease-osmosis)]',
